...
impl use_cases::create_account::DatabaseRead for S {}

impl DatabaseRead for S {
    type Db<'a> = db_transaction::S<'a>;
    type Input = use_cases::create_account::ReadInput;
    type Output = use_cases::create_account::ReadOutput;
    ...
    async fn read(
        ...
        Ok(use_cases::create_account::ReadOutput {
...
impl DatabaseWrite for S {
    type Db<'a> = db_transaction::S<'a>;
    type Input = use_cases::create_account::Ok;
