...
impl use_cases::get_all_accounts_for_branch::Input {
    pub(crate) async fn handle_operation<
        Id: RowId,
        Cli: DBClient,
        Db: for<'a> use_cases::get_all_accounts_for_branch::DatabaseRead<Db<'a> = Cli>,
    >(
        &self,
        side_effects: &mut SideEffects,
        client: &mut Cli,
    ) -> Result<use_cases::get_all_accounts_for_branch::MyResult, DynamicError> {
